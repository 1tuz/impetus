...
| --- | --- | --- | --- | --- | --- | --- |
| Разделение `core` / client | `agentic-terminal-core` не зависит от GPUI; GPUI app зависит от core | Harness и clients — отдельные процессы/crates | GPUI app всё ещё владеет runtime и SQLite | P0 | высокий | M |
...
- независимый от GPUI crate `agentic-terminal-core`;
