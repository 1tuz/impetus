# Historical detail: v0.2 gates

> Этот файл сохраняет детализацию исходного v0.2 плана. Единственный active
> порядок и статус — [ROADMAP.md](../ROADMAP.md); при расхождении он приоритетен.

Это snapshot исходной декомпозиции v0.2. Часть gates уже реализована, поэтому
он не задаёт следующий slice. Актуальный порядок и статус — только в
